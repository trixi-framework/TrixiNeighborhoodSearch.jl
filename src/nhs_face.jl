...
# TODO: `Shapes` only exists in TrixiParticles.jl
@inline function face_vertices(edge, shape::Shapes{2})
...
# TODO: `Shapes` only exists in TrixiParticles.jl
@inline function face_vertices(triangle, shape::Shapes{3})
...
@inline face_normal(triangle, shape) = shape.normals_face[triangle]
